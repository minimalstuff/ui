...
export const BASE_INPUT_STYLES = `w-full border ${CONTROL_BORDER} ${CONTROL_BG} ${FIELD_TEXT_COLORS} ${FIELD_FOCUS_RING} transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed`;
